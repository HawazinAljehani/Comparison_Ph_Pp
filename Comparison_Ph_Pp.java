 ...
 * @author hawazin
 */
public class Comparison_Ph_Pp {

    /*
    
     This is a solution to task 3
    
    3   Implement Prim’s algorithm using min-heap, then compare and plot the run times 
        of min-heap and pq-based implementations of Prim’s algorithm for the above 10 cases
       of the randomly generated graphs.
    
      so we comparison, we randomly generate Graphs and send them to Min-Heap Prim and 
      Priority-Queue prim algorithms and calculate time using System.nanoTime(); in Java
